...
namespace EventBus.AzureServiceBus
{
	public class EventBusServiceBus:BaseEventBus
	{
		...
		private void RegisterSubscriptionClientMessageHandler(ISubscriptionClient subscriptionClient)
		{
			...
			new MessageHandlerOptions(ExceptionReviceHandler) { MaxConcurrentCalls = 10, AutoComplete = false });
		}

		private Task ExceptionReviceHandler(ExceptionReceivedEventArgs exceptionReceivedEventArgs)
		{
